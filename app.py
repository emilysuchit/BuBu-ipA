...
# ═══════════════════════════════════════════════════════════════════
# GraphQL Queries - Placeholder များ
# သင့်ရဲ့ GraphQL query တွေကို ဒီမှာ ထည့်ပါ
# ═══════════════════════════════════════════════════════════════════
...
async def make_graphql_request_with_captcha_handling(
    ...
    return None, "All retries failed", False
...
async def process_card(cc, mes, ano, cvv, site_url, variant_id=None, proxy_str=None):
    ...
    try:
        ...
        async with aiohttp.ClientSession(connector=connector, timeout=timeout) as session:
            ...
            # Add checkout-specific headers for modern Shopify
            headers.update({
            ...
            final_text = ""  # ← FIX: default value ထည့်ထားတယ်
...
def shopify_checker_parallel():
    ...
    try:
        ...
        # စောင့်ဆိုင်းချိန် timeout ထည့်ထားတယ်
